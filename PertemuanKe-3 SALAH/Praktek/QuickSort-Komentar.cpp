// Program ini mengimplementasikan algoritma Quick Sort untuk mengurutkan array integer
...
// yang lebih kecil dari pivot ke bagian kiri, dan yang lebih besar ke bagian kanan
int part(int ar[], int lowdani, int highfahdlu) {
   ...
   // Lakukan partisi dengan memindahkan elemen lebih kecil dari pivot
   // ke bagian kiri, dan yang lebih besar ke bagian kanan
